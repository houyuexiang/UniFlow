...
public class DmsDatabaseService
{
    ...
    public DmsDatabaseService(ILogger<DmsDatabaseService> logger, Models.DmsOrderConfig config)
    {
        _logger = logger;
        _config = config;
    }
    ...
    private string ConnectionString =>
        ...
        $"User={_config.DbUser};Password={_config.DbPassword};AllowUserVariables=True;";
