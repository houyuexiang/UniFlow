...
public class HealthStore : IDisposable
{
    ...
    public void RecordHealth(string module, string status, string? message = null)
    {
        try
        {
            using var cmd = _conn.CreateCommand();
    ...
    public void RecordError(string module, string level, string message)
    {
        try
        {
            using var cmd = _conn.CreateCommand();
    ...
    public List<Dictionary<string, object>> GetHealthHistory(int days, string? module = null)
    {
    ...
    public List<Dictionary<string, object>> GetErrors(int days, string? module = null, string? level = null)
    {
        var results = new List<Dictionary<string, object>>();
        var cutoff = DateTime.Now.AddDays(-days).ToString("yyyy-MM-dd HH:mm:ss");
    ...
    public Dictionary<string, object> GetLatestModuleStatus()
    {
    ...
    public (int healthy, int degraded, int down) GetAggregatedStatus()
    {
        var statuses = GetLatestModuleStatus();
        int h = 0, d = 0, dn = 0;
